...
Here we consider the problem of interval estimation. A 95\% interval estimate should contain the true value with at least 95\% chance --regardless of if, when or why data collection stopped. 

We illustrate the following: 

1. [The 95\% classical confidence intervals fail to cover the true mean with 95\% chance across time](#classicalConfidenceIntervals)
2. [Similarly, the 95\% credible intervals fails to cover the true mean with 95\% chance across time](#credibleIntervals)
...
# 1. <a name = "classicalConfidenceIntervals">The 95\% classical confidence intervals fail to cover the true mean with 95\% chance across time</a>
...
plot(1:n, freqCoverageRate, type="l", lwd=2, xlab="n",
     ylab="Coverage rate", col=freqColours[1], ylim=c(0.6, 1))
lines(c(1, n), c(1-alpha, 1-alpha), lwd=2, lty=2)
```
...
# 2. <a name = "credibleIntervals">The 95\% credible intervals fail to cover the true mean with 95\% chance across time</a>
...
plot(1:n, 1-complementCoverageRate, type="l", lwd=2, xlab="n",
     ylab="Coverage rate", col=bayesColours[1], ylim=c(0.6, 1))
lines(c(1, n), c(1-alpha, 1-alpha), lwd=2, lty=2)
```
...
plot(1:n, anytimeCiCoverageRate, type="l", lwd=2, xlab="n",
     ylab="Coverage rate", col=eColours[1], ylim=c(0.6, 1))
lines(c(1, n), c(1-alpha, 1-alpha), lwd=2, lty=2)
```
...
plot(1:n, anytimeCiCoverageRate, type="l", lwd=2, xlab="n",
     ylab="Coverage rate", col=eColours[1], ylim=c(0.6, 1))
lines(1:n, bayesCoverageRate, col=bayesColours[1], lwd=2)
lines(1:n, freqCoverageRate, col=freqColours[1], lwd=2)
lines(c(1, n), c(1-alpha, 1-alpha), lwd=2, lty=2)
```
