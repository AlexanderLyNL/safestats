...
The above plot shows that in our confidence sequence, from time point 19 onwards, $0$ is not included in the confidence interval (grey dashed line). The precision indicates how many difference values between -1 and 1 are checked while building the confidence sequence. To decrease vignette building time, a low precision was chosen here, but it is recommended to set this value to 100 (default).
