...
Based on a tolerable type I error of $\alpha = 0.05$, type II error of $\beta = 0.20$, and minimal clinical effect size of $\delta_{\min} = 0.42$, the following code shows that we then need to plan an experiment consisting of 63 patients in each group:
