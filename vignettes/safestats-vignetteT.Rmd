...
firstPassageTimeAltEqual[
  which(simDeltaTrueIsDeltaMin$breakVector==1)] <- Inf
...
firstPassageTimeAltLarger <- 
  simDeltaTrueLargerDeltaMin$stoppingTimes
firstPassageTimeAltLarger[
  which(simDeltaTrueLargerDeltaMin$breakVector==1)] <- Inf
...
#   designSaviTwoProportions(deltaMin=0.3, alpha=0.05, beta=0.20, lowN=120,
#                            sampleSizeRatio=2)
# safeDesignProportionsImbalanced
```
untill here -->
